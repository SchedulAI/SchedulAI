...
export const llm = {
  ...
  prompt: `
    ...
    Regras:
    1. Para o host, solicite informações sobre o evento uma de cada vez, as informações em ordem são: título e descrição (juntos), datas com horários disponíveis, nome dos convidados e email dos convidados (juntos).
